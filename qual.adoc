...
image:photo/stalagmite-example.jpg[]
...
image::diagram/karst-3-proj.svg[]
...
=== !
image:extern/Haicheng-rain-isotope.svg[]

=== !
image:extern/Haicheng-rain-moisture.svg[]

=== !
image:extern/monsoons-map.webp[]
...
image:diagram/haicheng-2-monsoon.svg[]
...
image:diagram/karst-conduit-composite.svg[]
...
image:diagram/karst-func.svg[]

=== Notes on stalagmite calcite
image:diagram/inverse-func.svg[]

== C: Our Stalagmites

image:photo/all-stalagmites-small.jpg[]

=== !

image:photo/all-stalagmites-notes.jpg[]
...
image:diagram/hendy-example.png[]

_(Example Hendy Test)_

== B: Cave/Rain Monitoring

image:photo/collage.jpg[]


== B: Equipment isotopic distortion

image:diagram/thammurd-equipment-onsite.svg[]
...
image:diagram/thammurd-500m-onsite.svg[]
...
image:imergination/summary/sv-projections-monthly-daily.svg[]

Daily data gives near-identical patterns, but allows for a more fine-grained look at the changes in climate

== A: Index generation

image:imergination/summary/indeces-monthly-daily.svg[]
...
image:imergination/summary/designaled-long-linked.png[]
...
image:imergination/summary/designaled-weighted-long-linked.png[]
